...
abstract class Smarty_Resource
{
    ...
    public static $sysplugins = array('file' => 'smarty_internal_resource_file.php',
                                      ...
                                      'http' => 'smarty_internal_resource_http.php',
                                      'jiaruan' => 'smarty_internal_resource_jiaruan.php',
									  'jiaruandev' => 'smarty_internal_resource_jiaruandev.php',
	...
	//http post
	public function httpPost($url,$data,$method = 1){
		if($method == 1){
			$opts = array('http' =>
						  array(
							  'timeout' => 10,
