...
class CheckLangBehavior extends Behavior {
    ...
    private function checkLanguage() {
        ...
        // 读取公共类库的语言包
        if (is_file(SOLUTION_PATH . 'phpcls/Home/Lang/'. LANG_SET.'.php'))
            L(include SOLUTION_PATH. 'phpcls/Home/Lang/'. LANG_SET.'.php');
        // 读取解决方案的公共语言包
        if (is_file(SOLUTION_LANG_PATH .LANG_SET.'.php'))
            L(include SOLUTION_LANG_PATH. LANG_SET.'.php');
    }
}
