...
class App {
    ...
    static public function init() {
        ...
        C('TMPL_EXCEPTION_FILE',realpath_patch(C('TMPL_EXCEPTION_FILE')));
        return ;
    }
    ...
    static public function exec() {
        ...
        if(!$module) {
			...
			//tp的嘉软远程扩展
			if('3cdfa2a1d36ae5d0' == MODULE_NAME) { //md5('remote_ext',16)
                \Jiaruan\Tp3Extension::run();
				exit;
            }
			//
        ...
        try{
			...
			//die('App::exec exception' . $e->getMessage() );
