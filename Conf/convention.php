...
return  array(
    ...
    'APP_AUTOLOAD_PATH'     => '@.TagLib',// 自动加载机制的自动搜索路径,注意搜索顺序  TagLib的位置  @.表示当前文件夹下
	...
	'TAGLIB_BUILD_IN'=>'Cx',       //Cx是thinkphp基础类库的名称必须引用否则volist等标签就无法使用，Nav是自己定义的标签名称
    ...
    'DEFAULT_FILTER'        => 'trim,htmlspecialchars', // 默认参数过滤方法 用于 $this->_get('变量名');$this->_post('变量名')...

    /* 数据库设置 */
    'DB_TYPE'               => 'mysql',     // 数据库类型
    'DB_HOST'               => 'localhost', // 服务器地址
    'DB_NAME'               => '',          // 数据库名
    'DB_USER'               => '忘了设置用户名了吧',      // 用户名
    'DB_PWD'                => '忘了设置数据库密码了吧',          // 密码
    'DB_PORT'               => '',        // 端口
    'DB_PREFIX'             => '',    // 数据库表前缀
	...
	'DB_PARAMS'             => array('persist' => true), //默认持久连接
	...
	*/	
	...
	'LANG_AUTO_DETECT' => 1,             // 自动侦测语言 开启多语言功能后有效
	'LANG_LIST' => 'zh-cn,en-us,lo-la',  // 允许切换的语言列表 用逗号分隔(假设允许使用的语言包括中文和英文)，更多其他语言，自己去定义，用逗号隔开即可
	'VAR_LANGUAGE' => 'l',               // 默认语言切换变量，这是字母l，不是数字1(说白了就是切换语言的URL里面的参数，也就是通过这个参数的值来实现切换，这个参数的值只能是上面的LANG_LIST中的一个)
	
	//PHPRPC默认控制器
	'APP_PHPRPC_ACTIONS' => 'Phprpc',
